    ...
    <>
      ...
      <header style={{ borderBottom: 'var(--border-thick)', padding: '16px 0', backgroundColor: 'var(--bg-main)', position: 'relative', zIndex: 60 }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', alignItems: 'center', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: 'clamp(1rem, 4vw, 1.5rem)', fontWeight: '700', fontFamily: 'var(--font-serif)', color: 'var(--color-primary-dark)', lineHeight: 1.2 }}>
          ...
          <nav className="desktop-only" style={{ display: 'flex', gap: '24px', alignItems: 'center', fontWeight: '600', justifyContent: 'center' }}>
            <a href="#about" style={{ color: 'var(--color-primary-dark)' }}>Who This Is For</a>
            <a href="#course" style={{ color: 'var(--color-primary-dark)' }}>The Journey</a>
            <a href="#faq" style={{ color: 'var(--color-primary-dark)' }}>FAQ</a>
          </nav>
          ...
          <div className="mobile-only" style={{ gridColumn: '3', display: 'flex', justifyContent: 'flex-end' }}>
            <button onClick={() => setIsMobileMenuOpen(true)} style={{ padding: '8px', fontSize: '1.5rem', color: 'var(--color-primary-dark)', cursor: 'pointer' }}>
              ☰
            </button>
          </div>
        </div>
      ...
      {isMobileMenuOpen && (
        <div className="mobile-menu-overlay">
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '32px' }}>
            <button onClick={() => setIsMobileMenuOpen(false)} style={{ padding: '8px', fontSize: '2rem', color: 'var(--color-primary-dark)', lineHeight: 1, cursor: 'pointer' }}>
              ×
            </button>
          </div>
          <nav style={{ display: 'flex', flexDirection: 'column', gap: '32px', alignItems: 'center', fontWeight: '700', fontSize: '1.5rem', color: 'var(--color-primary-dark)' }}>
            <a href="#about" onClick={() => setIsMobileMenuOpen(false)}>Who This Is For</a>
            <a href="#course" onClick={() => setIsMobileMenuOpen(false)}>The Journey</a>
        ...
        <div className="container">
          <div className="footer-flex">
            ...
            <nav style={{ display: 'flex', gap: '24px', fontWeight: '600', flexWrap: 'wrap', justifyContent: 'center' }}>
              <a href="https://youtube.com/@aifounderblueprint" target="_blank" rel="noreferrer">YouTube</a>
              <a href="https://instagram.com/@aifounderblueprint" target="_blank" rel="noreferrer">Instagram</a>
              <a href="mailto:hello@aifounderblueprint.com">Contact</a>
            </nav>
            <div style={{ fontWeight: '500', opacity: 0.8 }}>
